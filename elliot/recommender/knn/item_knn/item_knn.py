...
class ItemKNN(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_nbits", "nbits", "bits", None, None, None),
            ("_ntables", "ntables", "tables", None, None, None),
        ...
        if self._implementation == "aiolli":
            ...
            if (not self._normalize) or (self._asymmetric_alpha) or (self._tversky_alpha) or (self._tversky_beta) or (
                    self._row_weights) or (self._shrink):
                self.logger.info(
    ...
    def train(self):
        ...
        # NUOVA RIGA AGGIUNTA
        similarity_computation_time = end - start
        print(f"The similarity computation has taken: {similarity_computation_time}")

        print(f"Transactions: {self._data.transactions}")
        self.evaluate()
        # Riga aggiunta.Prima l'ultima riga era self.evaluate()
        return similarity_computation_time
