...
class HyperParameterStudy:
    ...
    def save_comparisons(self, base, output='../results_lsh/'):
        dataset = base.config["experiment"]["dataset"]
        output = os.sep.join([output, "results_lsh/comparisons", dataset])
        os.makedirs(output, exist_ok=True)
        for k in self.ks:
            for rec, performance in self.trials.items():
                current_output_path = os.sep.join([output, rec])
