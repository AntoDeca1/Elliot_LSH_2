...
baseline_path = "results_lsh/comparisons/movielens_1m/ItemKNN/ItemKNN_baseline.tsv"
lsh_path = "results_lsh/comparisons/movielens_1m/ItemKNN/ItemKNN_rp_hashtables.tsv"
